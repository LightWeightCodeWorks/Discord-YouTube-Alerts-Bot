  ...
  async execute(interaction) {
    const helpEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'Optional Step: Choose role to ping your users', value: 'Use `/setpingrole` with the Discord Server role you like to use for alerts. (Default role is @everyone)' },
